 ...
 * 
 * import com.webdev.dto.ApplicationDTO; import
 * com.webdev.services.ApplicationService; import
 * com.webdev.services.ApplicationServiceHibImpl;
 * 
 ...
 * applicationDTO.setName("Test Module 1"); applicationDTO
 * .setDescription("This is a test module from JUnit tesecase" + new Date()); //
 ...
 * 
 * @Test public void testAddApplication() {
 * 
 * ApplicationDTO applicationDTO = new ApplicationDTO();
 * applicationDTO.setName("Test Module 1"); applicationDTO
 * .setDescription("This is a test module from JUnit tesecase" + new Date()); //
 ...
 * }
 * 
 * @Test public void testDeleteApplication() {
 * 
 * ApplicationDTO applicationDTO = new ApplicationDTO();
 * applicationDTO.setName("Test Module 1"); applicationDTO
 ...
 * 
 * @Test public void testUpdateApplication() {
 * 
 * ApplicationDTO applicationDTO = service.getApplication(1);
 * 
 * String str = "This is a test module update from JUnit tesecase" + new Date();
 * 
 ...
 * 
 * @Test public void testGetApplicationList() { List list =
 * service.getApplicationList(); assertTrue(list.size() > 0); }
 * 
 * }
 */